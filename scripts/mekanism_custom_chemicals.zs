...
InfuseTypeBuilder.builder().color(0x22174b).build("void");
InfuseTypeBuilder.builder().color(0xe5ddff).build("radiance");
InfuseTypeBuilder.builder().color(0x4bacbd).build("osmium");